# %%
# I wanna put this file to branch - diamonds_predictive_analysis
# %% [markdown]
# # 1. Import Packages
# %%
...
#      a visualization of 1 to 50 neighbors
neighbors_settings = list(range(1, 3))
neighbors_settings
...
model_performance = model_performance.append(
    {'Model': 'LinearRegression',
     'Training Accuracy': lr_train_score,
...
model_performance = model_performance.append(
    {'Model': 'Ridge',
     'Training Accuracy': ridge_train_score,
     'Testing Accuracy': ridge_test_score
     },
    ignore_index=True)
...
# %%
# It took a long time to run GridSearch, so I just comment them and manually input the best parameters.
...
model_performance = model_performance.append(
    {'Model': 'Random Forest',
     'Training Accuracy': rfr_train_score,
     'Testing Accuracy': rfr_test_score
     },
    ignore_index=True)
...
model_performance = model_performance.append(
    {'Model': 'GBDT',
     'Training Accuracy': gbdt_train_score,
     'Testing Accuracy': gbdt_test_score
     },
    ignore_index=True)
...
# %% [markdown]
# Insight:<br>
# Compare all the performance of the six models, we can see Random Forest Regression is the best.
#  'Training Accuracy' is 0.997, 'Testing Accuracy' is 0.981
